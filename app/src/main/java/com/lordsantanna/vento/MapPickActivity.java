    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(final MapboxMap mapboxMap) {
                ...
                //mapboxMap.getUiSettings().setCompassMargins(mapboxMap.getUiSettings().getCompassMarginLeft(),mapboxMap.getUiSettings().getCompassMarginTop() + ABHeight,mapboxMap.getUiSettings().getCompassMarginRight(), mapboxMap.getUiSettings().getCompassMarginBottom()+bt_pick_Height);
